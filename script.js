...
viewProjectButtons.forEach(button => {
  button.addEventListener('click', function(e) {
    ...
    if (project) {
      ...
      document.getElementById('popupSales').textContent = project.sales;
      document.getElementById('popupDelivery').textContent = project.delivery;
      document.getElementById('popupRevisions').textContent = project.revisions;
      document.getElementById('popupIncluded').textContent = project.included;
